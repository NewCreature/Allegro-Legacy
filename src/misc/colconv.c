...
static void build_rgb_scale_5235_table(int to_depth)
{
   ...
   if (to_depth == 24)
      ...
      _colorconv_rgb_scale_5x35 = _AL_LEGACY_MALLOC_ATOMIC(sizeof(int)*1536);
   else if (to_depth == 32)
      /* 2 contiguous 256-entry tables (2k) */
      _colorconv_rgb_scale_5x35 = _AL_LEGACY_MALLOC_ATOMIC(sizeof(int)*512);
...
static void create_indexed_palette(int to_depth)
{
   ...
   _colorconv_indexed_palette = _AL_LEGACY_MALLOC_ATOMIC(sizeof(int) * indexed_palette_size);
}
...
static void create_rgb_map(int from_depth)
{
   ...
   _colorconv_rgb_map = _AL_LEGACY_MALLOC_ATOMIC(sizeof(int) * rgb_map_size);
}
...
void _release_colorconv_blitter(COLORCONV_BLITTER_FUNC *blitter)
{
   ...
   if (_colorconv_indexed_palette) {
      _AL_LEGACY_FREE(_colorconv_indexed_palette);
