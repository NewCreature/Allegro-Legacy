 ...
 */
int clip3d(int type, fixed min_z, fixed max_z, int vc, AL_LEGACY_CONST V3D *vtx[], V3D *vout[], V3D *vtmp[], int out[])
{
   int i, j, vo, vt, flags;
   fixed t;
   V3D *v3;

   AL_LEGACY_CONST V3D *v1, *v2, **vin;
