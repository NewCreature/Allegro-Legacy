...
TIMER_DRIVER timer_allegro5 = {
   ...
   NULL, //be_time_init,	// AL_METHOD(int, init, (void));
   NULL, //be_time_exit,	// AL_METHOD(void, exit, (void));
   ...
   NULL, //be_time_rest,	// AL_METHOD(void, rest, (long time, AL_METHOD(void, callback, (void))));
};
