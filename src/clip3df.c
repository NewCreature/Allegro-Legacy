 ...
 *  big as vtx.
 */
int clip3d_f(int type, float min_z, float max_z, int vc, AL_LEGACY_CONST V3D_f *vtx[], V3D_f *vout[], V3D_f *vtmp[], int out[])
{
   int i, j, vo, vt, flags;
   float t;
   V3D_f *v3;

   AL_LEGACY_CONST V3D_f *v1, *v2, **vin;
   ...
   if (max_z > min_z) {
	 ...
	 if (out[j])
      ...
      vin = (AL_LEGACY_CONST V3D_f**)vtmp;
   }
   else {
      vt = vc;
      vin = vtx;
