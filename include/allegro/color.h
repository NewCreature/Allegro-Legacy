...
AL_LEGACY_VAR(PALETTE, black_palette);
AL_LEGACY_VAR(PALETTE, desktop_palette);
AL_LEGACY_VAR(PALETTE, default_palette);
...
AL_LEGACY_VAR(int, _rgb_b_shift_15);
AL_LEGACY_VAR(int, _rgb_r_shift_16);
AL_LEGACY_VAR(int, _rgb_g_shift_16);
AL_LEGACY_VAR(int, _rgb_b_shift_16);
AL_LEGACY_VAR(int, _rgb_r_shift_24);
AL_LEGACY_VAR(int, _rgb_g_shift_24);
AL_LEGACY_VAR(int, _rgb_b_shift_24);
AL_LEGACY_VAR(int, _rgb_r_shift_32);
AL_LEGACY_VAR(int, _rgb_g_shift_32);
AL_LEGACY_VAR(int, _rgb_b_shift_32);
AL_LEGACY_VAR(int, _rgb_a_shift_32);

AL_LEGACY_ARRAY(int, _rgb_scale_5);
AL_LEGACY_ARRAY(int, _rgb_scale_6);
...
AL_LEGACY_FUNC(void, set_blender_mode, (BLENDER_FUNC b15, BLENDER_FUNC b16, BLENDER_FUNC b24, int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_blender_mode_ex, (BLENDER_FUNC b15, BLENDER_FUNC b16, BLENDER_FUNC b24, BLENDER_FUNC b32, BLENDER_FUNC b15x, BLENDER_FUNC b16x, BLENDER_FUNC b24x, int r, int g, int b, int a));

AL_LEGACY_FUNC(void, set_alpha_blender, (void));
AL_LEGACY_FUNC(void, set_write_alpha_blender, (void));
AL_LEGACY_FUNC(void, set_trans_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_add_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_burn_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_color_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_difference_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_dissolve_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_dodge_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_hue_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_invert_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_luminance_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_multiply_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_saturation_blender, (int r, int g, int b, int a));
AL_LEGACY_FUNC(void, set_screen_blender, (int r, int g, int b, int a));
...
AL_LEGACY_FUNC(int, makecol_depth, (int color_depth, int r, int g, int b));

AL_LEGACY_FUNC(int, makeacol, (int r, int g, int b, int a));
AL_LEGACY_FUNC(int, makeacol_depth, (int color_depth, int r, int g, int b, int a));

AL_LEGACY_FUNC(int, makecol15_dither, (int r, int g, int b, int x, int y));
AL_LEGACY_FUNC(int, makecol16_dither, (int r, int g, int b, int x, int y));

AL_LEGACY_FUNC(int, getr, (int c));
AL_LEGACY_FUNC(int, getg, (int c));
AL_LEGACY_FUNC(int, getb, (int c));
AL_LEGACY_FUNC(int, geta, (int c));

AL_LEGACY_FUNC(int, getr_depth, (int color_depth, int c));
AL_LEGACY_FUNC(int, getg_depth, (int color_depth, int c));
AL_LEGACY_FUNC(int, getb_depth, (int color_depth, int c));
AL_LEGACY_FUNC(int, geta_depth, (int color_depth, int c));
