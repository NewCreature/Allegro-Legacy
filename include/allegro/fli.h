...
AL_LEGACY_FUNC(void, reset_fli_variables, (void));

AL_LEGACY_VAR(struct BITMAP *, fli_bitmap);   /* current frame of the FLI */
AL_LEGACY_VAR(PALETTE, fli_palette);          /* current FLI palette */

AL_LEGACY_VAR(int, fli_bmp_dirty_from);       /* what part of fli_bitmap is dirty */
AL_LEGACY_VAR(int, fli_bmp_dirty_to);
AL_LEGACY_VAR(int, fli_pal_dirty_from);       /* what part of fli_palette is dirty */
AL_LEGACY_VAR(int, fli_pal_dirty_to);

AL_LEGACY_VAR(int, fli_frame);                /* current frame number */

AL_LEGACY_VAR(volatile int, fli_timer);       /* for timing FLI playback */
