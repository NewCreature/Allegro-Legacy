...
static void *griddlit(DATAFILE **parent, AL_LEGACY_CONST char *name, int c, int type, int skipempty, int autocrop, int depth, int x, int y, int w, int h)
{
   DATAFILE *dat;
   BITMAP *bmp;
   void *v;
...
static void *box_griddle(DATAFILE **parent, AL_LEGACY_CONST char *name, int type, int skipempty, int autocrop, int depth)
{
   void *ret = NULL;
   void *item;
   int x, y, w, h;
...
static void *grid_griddle(DATAFILE **parent, AL_LEGACY_CONST char *name, int type, int skipempty, int autocrop, int depth, int xgrid, int ygrid)
{
   void *ret = NULL;
   void *item;
   int x, y;
...
static AL_LEGACY_CONST char *typelist_getter(int index, int *list_size)
{
   static char *str[] =
   {
      "Bitmap",
...
static AL_LEGACY_CONST char *depthlist_getter(int index, int *list_size)
{
   static char *str[] =
   {
      "256 color palette",
...
static int grid_name_matches(AL_LEGACY_CONST char *gn, AL_LEGACY_CONST char *n)
{
   AL_LEGACY_CONST char *s;
